...
https://vimeo.com/123456789`}
              className="w-full h-32 px-3 py-2 text-sm border border-zinc-300 dark:border-zinc-800 rounded-lg 
                         bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 
                         placeholder-zinc-500 dark:placeholder-zinc-400 
                         focus:outline-none focus:ring-2 focus:ring-zinc-500 dark:focus:ring-zinc-500 focus:border-transparent
          ...
          {previewUrls.length > 0 && (
            <Card className="bg-gray-50 dark:bg-zinc-900/50 border-zinc-300 dark:border-zinc-800 shadow-sm">
